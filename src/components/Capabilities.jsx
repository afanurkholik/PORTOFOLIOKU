          ...
          {Object.entries(capabilities).map(([key, items], index) => {
            ...
            return (
              <motion.div
                ...
                className="p-6 rounded-2xl bg-surface border border-white/5 hover:border-accent/20 transition-all"
              >
                <Icon className="text-accent mb-4" size={28} />
                <h3 className="font-display text-lg font-bold mb-4 uppercase tracking-wider">{key}</h3>
